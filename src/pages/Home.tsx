    ...
    <div>
      ...
      <section id="sites" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex items-center gap-3 mb-12">
          ...
          <h2 className="text-3xl font-serif text-stone-800 px-4">{t("sites_heading")}</h2>
          <div className="h-px flex-grow bg-stone-200"></div>
        </div>
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider text-amber-800 border border-amber-100 flex items-center gap-1">
                  <Landmark className="w-3 h-3" /> {t("site_ar_badge")}
                </div>
              </div>
              <div className="p-8 flex flex-col flex-grow">
                <h3 className="text-2xl font-serif text-stone-800 mb-2">{lang === 'id' && site.name_id ? site.name_id : site.name}</h3>
      ...
      <section id="ar-guide" className="bg-stone-100 pt-20 pb-10 border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif text-stone-800 mb-4">{t("guide_title")}</h2>
            <p className="text-stone-500 max-w-2xl mx-auto">{t("guide_subtitle")}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <h4 className="font-bold text-stone-800 mb-2">{t("guide_step1_title")}</h4>
              <p className="text-sm text-stone-500">{t("guide_step1_desc")}</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h4 className="font-bold text-stone-800 mb-2">{t("guide_step2_title")}</h4>
              <p className="text-sm text-stone-500">{t("guide_step2_desc")}</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h4 className="font-bold text-stone-800 mb-2">{t("guide_step3_title")}</h4>
              <p className="text-sm text-stone-500">{t("guide_step3_desc")}</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h4 className="font-bold text-stone-800 mb-2">{t("guide_step4_title")}</h4>
              <p className="text-sm text-stone-500">{t("guide_step4_desc")}</p>
            </div>
          </div>
          ...
          <div className="mt-16 p-8 bg-amber-50 rounded-3xl border border-amber-100 flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              <h5 className="font-bold text-amber-900 mb-1">{t("guide_sysreq_title")}</h5>
              <p className="text-sm text-amber-800/80">
                {t("guide_sysreq_desc")} <strong>{t("guide_sysreq_android")}</strong> {t("guide_sysreq_or")} <strong>{t("guide_sysreq_ios")}</strong>.
              </p>
            </div>
          </div>
        </div>
